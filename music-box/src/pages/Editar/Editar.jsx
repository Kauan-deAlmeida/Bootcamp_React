...
import imgPessoaOuvindoMusica from "../../utils/assets/pessoa-ouvindo-musica.svg";
...
function Editar() {
    ...
    useEffect(() => {
        api.get(`/${idCard}`).then((response) => {
            ...
            .catch((error) => {
                console.log("Erro ao buscar os detalhes da música:",
                    error);
            })
    }, [idCard]);
                    ...
                    <form>
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange(e,
                                setImagem)}
                        />
                        <div className={styles["buttons-containereditar"]}>
                            <button type="button"
                                onClick={handleSave}>
                                Salvar
                            </button>
